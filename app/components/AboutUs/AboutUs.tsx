      ...
      <div className="border-4 border-white p-8 rounded-lg max-w-3xl w-full">
        <section className='px-4'> 
          ...
          <p className='text-2xl text-white'>
            <br /> Headphone Plus emerged from a simple yet powerful idea: everyone deserves to experience music in its purest form.
            <br /><br /> Our journey began when a team of audio engineers and music enthusiasts came together with a shared vision of creating headphones that could adapt to each individual&apos;s unique sound profile.
          </p>
        </section>
      </div>
      {showScrollToTop && (
